...
ag100_1 = Blueprint(' ag8_40323145_1', __name__, url_prefix='/ ag8_40323145', template_folder='templates')

@ag8_40323145_1.route('/ ag8_40323145_task1')
def task0():
    return " ag8_40323145 task1"
    
@ag8_40323145_1.route('/ ag8_40323145')
def task1():
    #return "ag100 task1"
    return render_template('task1.html', var1="來自 ag100 的 task1 變數")

# 展示傳回 Brython 程式
@ag8_40323145_1.route('/task2')
def task2():
    outstring = '''
<!DOCTYPE html>
<html>
