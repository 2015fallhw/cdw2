...
import users.s2b.g3.scrum1_task40123235
...
# 註冊各組的程式 (第3步/總共3步, 前面1步為 import ag1)
app.register_blueprint(users.s2b.g3.task0.bg3)
app.register_blueprint(users.s2b.g3.scrum1_task40123242.scrum1_task40123242)
